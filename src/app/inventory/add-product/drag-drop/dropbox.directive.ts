...
export class DropboxDirective {
  ...
  onDragOver(e: DragEvent) {
    ...
    this.element.nativeElement.childNodes[1].innerText = 'Release to Upload Image';
    e.preventDefault();
  }

  @HostListener('dragleave')
  onDragLeave() {
    this.renderer.setStyle(this.element.nativeElement, 'border', '4px dashed var(--blue-gray)')
    this.element.nativeElement.childNodes[1].innerText = 'Drag & Drop to Upload File';
  }
